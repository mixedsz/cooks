-- ============================================================
-- fsg_cooking – client/cooking.lua
-- ============================================================
...
function StartCooking(entity, recipeName, recipe)
    ...
    local hasItems = lib.callback.await("fsg_cooking:server:checkRequiredItems", false, {
        recipe = recipeName,
        entity = entity,
    })
...
-- calls the server callback fsg_cooking:server:completeCooking.
-- ============================================================
...
function CompleteCooking(recipeName, success)
    ...
    lib.callback.await("fsg_cooking:server:completeCooking", false, {
        recipe  = recipeName,
        success = success,
    })
...
-- bar, then calls the server callback fsg_cooking:server:pickupProp.
...
function PickUpProp(entity, propType, propData)
    ...
    if confirmed then
        if DoesEntityExist(entity) then
            ...
            local result = lib.callback.await("fsg_cooking:server:pickupProp", false, netId, propDbId)
...
-- ============================================================
-- Callback: fsg_cooking:client:checkRequiredItems
-- Called by the server to verify the client has all ingredients.
-- ============================================================

lib.callback.register("fsg_cooking:client:checkRequiredItems", function(data)
    local recipe = Config.Recipes[data.recipe]
    return HasRequiredItems(cache.serverId, recipe.requiredItems)
end)

-- ============================================================
-- NetEvent: fsg_cooking:client:setPropOwner
-- Sets the state-bag owner of a networked entity.
-- ============================================================

RegisterNetEvent("fsg_cooking:client:setPropOwner", function(netId, ownerIdentifier)
